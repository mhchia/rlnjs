...
*/
(function (exports, bytes, solidity, strings, snarkjs, ffjavascript, poseidon, identity, incrementalMerkleTree) {
    'use strict';
...
})({}, bytes, solidity, strings, snarkjs, ffjavascript, poseidon, identity, incrementalMerkleTree);
